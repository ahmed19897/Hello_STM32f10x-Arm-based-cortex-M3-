...
extern volatile bool KeepPrintingCurrentLetter;
...
void HLEDMRX_VoidInit(void)
{
	 ...
	 MGPIO_VoidSetPinDirection(GPIOA,GPIN8,OUTPUT_SPEED_2MHZ_PP);
	 ...
	 MGPIO_VoidSetPinDirection(GPIOB,GPIN10,OUTPUT_SPEED_2MHZ_PP);
...
static void DisableAllCols(void)
{
	...
	MGPIO_VoidSetPinValue(GPIOA,GPIN7,GPIO_HIGH);
	MGPIO_VoidSetPinValue(GPIOA,GPIN8,GPIO_HIGH);
...
static void SetRowValues( int u8DataArray)
{
	...
	Local_u8Bit=GET_BIT(u8DataArray,7);
	MGPIO_VoidSetPinValue(GPIOB,GPIN10,Local_u8Bit);
